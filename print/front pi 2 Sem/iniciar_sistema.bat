...
timeout /t 2 >nul
start "" "%~dp0front pi 2 SemDsm\index.html"
echo Se o frontend nao abrir automaticamente, acesse: file:///%~dp0front pi 2 SemDsm/index.html
...
echo   file:///%~dp0front pi 2 SemDsm/index.html
...
start "" "%~dp0front pi 2 SemDsm\diagnostico.html"
echo.
echo Pressione qualquer tecla para voltar ao menu principal...
pause >nul
cls
